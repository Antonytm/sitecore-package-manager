...
const iconVariants = cva("inline-flex items-center justify-center", {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      colorScheme: "yellow",
      class:
        "bg-yellow-800 dark:bg-yellow-200 text-background dark:text-background",
    },
    {
      variant: "filled",
      colorScheme: "teal",
      class:
        "bg-teal-800 dark:bg-teal-200 text-background dark:text-background",
    },
    {
      variant: "filled",
      colorScheme: "cyan",
      class:
        "bg-cyan-800 dark:bg-cyan-200 text-background dark:text-background",
    },
    {
      variant: "filled",
      colorScheme: "blue",
      class:
        "bg-blue-800 dark:bg-blue-200 text-background dark:text-background",
    },
    {
      variant: "filled",
      colorScheme: "purple",
    ...
    },
    {
      ...
      colorScheme: "pink",
      class:
        "bg-pink-800 dark:bg-pink-200 text-background dark:text-background",
    },
  ],
  defaultVariants: {
    variant: "default",
