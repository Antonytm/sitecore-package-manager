...
//
// Initializes the Sitecore Marketplace Client SDK and exposes it as a React hook.
// Taken from the official Sitecore marketplace-starter; the XMC module is registered
// so we can call XM Cloud Authoring/Management APIs (reading/writing items) from the app.
